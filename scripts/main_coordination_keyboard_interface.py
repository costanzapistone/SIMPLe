"""
Authors: Giovanni Franzese, Costanza Pistone
...
class Coordination(DualPanda):
    def __init__(self):
        ...
        self.key_press_data = {
            'left': {'count': 0, 'TN': 0, 'FP': 0, 'No Action': 0},
            'right': {'count': 0, 'TP': 0, 'FN': 0, 'No Action': 0}            
        }
    ...
    def _on_press_arrow(self, key):
        ...
        if key == Key.right:
            ...
            random_index_r = np.random.choice(self.test[self.cl2].shape[1])
            ...
            if (pred_proba_r[0][1] > (0.5 + self.THRESHOLD)) or (pred_proba_r[0][0] > (0.5 + self.THRESHOLD)):
                ...
                if y_pred_r == 1:
                    ...
                    self.key_press_data['right']['TP'] += 1
                    ...
                    self.key_press_data['right']['FN'] += 1
                ...
                self.right = True
                # self.index_left=int(self.index_left+self.look_ahead)
                self.key_press_data['right']['No Action'] += 1
        ...
        if key == Key.left:
            ...
            random_index_l = np.random.choice(self.test[self.cl1].shape[1])
            sample_l = self.test[self.cl1][:, random_index_l]
    ...
    def store_experiment_data(self):
        ...
        data = [
            ...
            self.key_press_data['left']['TN'],
            self.key_press_data['left']['FP'],
            self.key_press_data['left']['No Action'],
            self.key_press_data['right']['count'],
            self.key_press_data['right']['TP'],
            self.key_press_data['right']['FN'],
            self.key_press_data['right']['No Action']
        ]
